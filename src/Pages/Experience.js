      ...
      {pagination === 1 ? (
        <motion.div className={"ExperienceDiv"}>
          <HorizontalCard
            ...
            first_bullet={
              "Worked on a website with 1000+ users that assisted vehicle engineers in their daily work"
            }
            second_bullet={
              "Created and improved parts of the website with React, Django, and Redux"
            }
            third_bullet={
              "Interacted with customers and developers to improve the website to tailor to their needs"
            }
          />
          <HorizontalCard
            image={Zotbins}
            ...
            first_bullet={
              "Worked on a mobile app to help users learn about environmentally-conscious practices"
            }
            second_bullet={
              "Created and redesigned parts of the app using React Native, Expo, and CSS"
            }
            third_bullet={
              "Cooperated with other developers and designers to foster new ideas and improve the app’s user experience"
            }
          />
        </motion.div>
      ) : (
        <motion.div className={"ExperienceDiv"}>
          <HorizontalCard
            ...
            first_bullet={
              "Overseeing three websites while maintaining and improving the usability of each website"
            }
            second_bullet={
              "Using HTML, CSS, and Javascript to maintain and update the website"
            }
            third_bullet={
              "Cooperating with other communication assistants to publicize news and events to people of all ages and professions"
            }
          />
          <HorizontalCard
            image={CircleK}
            ...
            first_bullet={
              "Managed and improved a website with 300-400 active accounts"
            }
            second_bullet={
              "Oversaw a Technology Internship Program of 16 members to improve the website with a productive learning environment"
            }
            third_bullet={
              "Worked with a board of 42 members to run the largest Circle K club in the world"
            }
          />
        </motion.div>
      )}
