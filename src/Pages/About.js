...
function About() {
  var containerVariants = {
    ...
    exit: {
      x: "-100vh",
      opacity: 0,
      transition: { ease: "easeInOut", duration: 0.85, opacity: 0 },
    },
  };
        ...
        <div className="personal_blurb">
          ...
          <div className="basic_info">
            <p className="basic_info_text">
              Hello, my name is Tin Luu, and I'm a 4th Year Computer Science
              Major at the University of California, Irvine.
            </p>
            <p className="basic_info_text">
              In the computer science industry, my main interests are in Web
              Developement and Mobile Developement. I enjoy working on projects
              that can make a positive impact in the world and on my skills as a
              software developer. I am constantly working on new projects to
              learn more technologies and to grow as a developer.
            </p>
            <p className="basic_info_text">
